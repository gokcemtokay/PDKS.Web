...
function OneriList() {
    ...
    const columns: GridColDef[] = [
        ...
        { field: 'baslik', headerName: 'Başlık', width: 250 },
    ...
    return (
        <Box>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 3 }}>
                <Typography variant="h4" fontWeight="bold">Öneri & Şikayet</Typography>
                <Button variant="contained" startIcon={<AddIcon />}>Yeni Öneri/Şikayet</Button>
            </Box>
